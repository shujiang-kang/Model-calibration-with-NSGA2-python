...
from nsga2lib import Modelutilities
from math import floor

class nsga2:
    def __init__(self,ModeltxtinoutFolderDirectory):
        ...
        nsga2def = ModeltxtinoutFolderDirectory+"/NSGA2.IN/nsga2.def"
        nsga2pardef = ModeltxtinoutFolderDirectory+"/NSGA2.IN/nsga2_par.def"
        observed_rch = ModeltxtinoutFolderDirectory+"/NSGA2.IN/observed_rch.txt"
        f = open(nsga2def, "r")
        lines = f.readlines()
        ...
        self.nfunc=nfunc
        self.SWATdir=ModeltxtinoutFolderDirectory
        #---
        self.nmut=0
        self.ncross=0
    ...
    def CreateInitialPopulation(self):
        ...
        if self.ReadMFrmOut == 1:#Read Last population from output.out
            ...
            Modelutilities.CalculateObjectiveFunctions(old_pop_ptr,self.Outlet_Obsdata,self.FuncOpt,self.FuncOptAvr,self.parname,"Previous NSGA-II run Last Population",self.SWATdir)
            ...
            #/*Function Calculaiton*/
            Modelutilities.CalculateObjectiveFunctions(InitialLHSpop,self.Outlet_Obsdata,self.FuncOpt,self.FuncOptAvr,self.parname,"LHS",self.SWATdir)
        ...
        Modelutilities.rankcon(old_pop_ptr)
